...
$whtl
cd "$myBaseDir/steem/programs/steemd/witness_node_data_dir/blockchain/database/" && sudo -s rm -f *.zip && wget http://einfachmalnettsein.de/steem-blocks-and-index.zip && sudo -s unzip -o steem-blocks-and-index.zip
